...
annotations_txt = open("uploads_src/200annotations1minuto.txt", "r")
...
mlii = np.array([float(i) for i in data.split()])
...
model.load_weights("uploads_src/SEMFILTROmodelo_CNN.h5")
